...
#if defined (__MACH__) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || defined(_WIN32)
...
//    // Allocate PSRAM buffers with 16-byte alignment for SIMD
//    // 1. Allocate usUnalignedPixels (pixel buffer)
//    pPage->usUnalignedPixels = (uint16_t*)heap_caps_aligned_alloc(
//        16,
//        (MAX_BUFFERED_PIXELS + 16) * sizeof(uint16_t),
//        MALLOC_CAP_SPIRAM
//    );
//    if (!pPage->usUnalignedPixels) {
//        pPage->iError = JPEG_INVALID_PARAMETER;
//        return 0;
//    }
//
//    // 2. Allocate sUnalignedMCUs (MCU coefficient buffer)
//    const int mcuBufferSize = (8 + (DCTSIZE * MAX_MCU_COUNT)) * sizeof(int16_t);
//    pPage->sUnalignedMCUs = (int16_t*)heap_caps_aligned_alloc(
//        16,
//        mcuBufferSize + 16,
//        MALLOC_CAP_SPIRAM
//    );
//    if (!pPage->sUnalignedMCUs) {
//        heap_caps_free(pPage->usUnalignedPixels);
//        pPage->usUnalignedPixels = nullptr;
//        pPage->iError = JPEG_INVALID_PARAMETER;
//        return 0;
//    }

...
//
int JPEGDEC::openRAM(uint8_t *pData, int iDataSize, JPEG_DRAW_CALLBACK *pfnDraw, uint16_t *usUnalignedPixels,
                     int16_t *sUnalignedMCUs, uint8_t *ucFileBuf) {
...
//    heap_caps_free(_jpeg.sUnalignedMCUs);
//    heap_caps_free(_jpeg.usUnalignedPixels);
//    _jpeg.sUnalignedMCUs = nullptr;
//    _jpeg.usUnalignedPixels = nullptr;
} /* close() */

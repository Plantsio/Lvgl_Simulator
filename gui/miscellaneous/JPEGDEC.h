...
#ifndef __JPEGDEC__
#define __JPEGDEC__
#if defined( __MACH__ ) || defined( __LINUX__ ) || defined( __MCUXPRESSO ) || defined( ESP_PLATFORM ) || defined(_WIN32)
...
class JPEGDEC {
public:
    int openRAM(uint8_t *pData, int iDataSize, JPEG_DRAW_CALLBACK *pfnDraw, uint16_t *usUnalignedPixels,
                int16_t *sUnalignedMCUs, uint8_t *ucFileBuf = nullptr);

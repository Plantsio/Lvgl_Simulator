...
namespace UI {
    ...
    private:
        static lv_anim_t anim_create_internal(lv_obj_t *obj, lv_anim_exec_xcb_t exec_cb, int value_start, int value_end,
                                              uint32_t duration,
                                              uint32_t delay = 0, uint32_t playback_time = 0,
                                              uint32_t playback_delay = 0, uint32_t repeat_cnt = 0,
